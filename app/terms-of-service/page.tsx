          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-justify">
                  ...
                  You shall not engage in activities that could harm, disrupt,
                  or interfere with the functioning of our services or infringe
            ...
            <section>
              ...
              <div className="space-y-4">
                <p className="text-muted-foreground text-justify">
                  ...
                  All content, software, and materials provided by Lumio AI are
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-justify">
                  ...
                  amount paid by you to Lumio AI for the specific service in
                  question.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground text-justify">
                ...
                exclusively in the courts located in California, United States.
              </p>
            </section>
